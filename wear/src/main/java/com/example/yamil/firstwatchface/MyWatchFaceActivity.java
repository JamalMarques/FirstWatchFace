...
public class MyWatchFaceActivity extends Activity {
    ...
    private static final String typeface = "fonts/Roboto/Roboto-BlackItalic.ttf";
    ...
    private String time_format_display = "hh:mm";
    private TextView mTime,mBattery;

    private BroadcastReceiver mTimeInfoReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            mTime.setText(new SimpleDateFormat(time_format_display).format(Calendar.getInstance().getTime()));
        }
    };
